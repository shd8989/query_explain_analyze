...
CREATE TABLE IF NOT EXISTS tb_result_querytest(query_seq bigserial, db_seq integer, test_scenario varchar(100), query varchar(500), return_data text, is_success varchar(7), error_msg varchar(500), execute_time varchar(20), insert_dt timestamp);
...
EXPLAIN ANALYZE
SELECT a.nickname, substring(b.query, 0, 20) AS query, b.is_success, b.return_data, b.error_msg
FROM tb_database a
